...
import { Card, Row, Col, Table, Tag, Button, message, Spin, Modal, Descriptions, Empty, Tabs, Space, Popconfirm, Tooltip, Typography } from 'antd'
import { API } from '../App'
...
export default function Reports() {
  ...
  useEffect(() => { fetchSummary(); fetchReports('all') }, [])
