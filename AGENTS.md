...
This project is indexed by GitNexus as **research-assistant** (19735 symbols, 36032 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
